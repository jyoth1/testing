 ...
 * PLACE ANY CUSTOMIZATIONS IN Si_Sites
 */

require_once 'include/SugarObjects/templates/company/Company.php';

class Si_Sites_sugar extends Company {
    public $new_schema = true;
    public $module_dir = 'Si_Sites';
    public $object_name = 'Si_Sites';
    public $table_name = 'si_sites';
